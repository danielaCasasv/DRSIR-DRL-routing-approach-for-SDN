        ...
        for stat in sorted(body, key=attrgetter('port_no')): #get the value of port_no form body
            ...
            if port_no != ofproto_v1_3.OFPP_LOCAL: #si es dif de puerto local del sw donde se lee port        
                if port_no != 1 and self.awareness.link_to_port :
                    ...
                    # file = '/home/controlador/ryu/ryu/app/OSPF_bwd/Proac/bw.txt'
                    file = '/home/controlador/ryu/ryu/app/OSPF_bwd/Proac/bw_r.txt'
                    ...
                    for k in list(link_to_port.keys()):
                        ...
                        if k[0] == dpid:
                            if link_to_port[k][0] == port_no:
                                ...
                                # ----------------------------------------- 
                                # bw_link = float(self.get_link_bw(file, dpid, dst_dpid))#23nodos
                                bw_link = float(100) #32nodos
...
########################################################################################
    ...
    def write_values(self):
        ...
        if self.delay.link_delay:
            ...
            file_metrics = '/home/controlador/ryu/ryu/app/OSPF_bwd/Proac/Metrics/'+str(self.count_monitor)+'_net_metrics.csv'
