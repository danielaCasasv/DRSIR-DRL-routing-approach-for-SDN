...
class simple_Delay(app_manager.RyuApp):
    ...
    def write_dijkstra_paths(self):
        ...
        with open('/home/controlador/ryu/ryu/app/OSPF_bwd/Proac/paths_bwd.json','w') as json_file:
            json.dump(paths, json_file, indent=2)
        
        total_time = time.time() - time_init
        # print(total_time)
        with open('/home/controlador/ryu/ryu/app/OSPF_bwd/Proac/times.txt','a') as txt_file:
    ...
    def get_paths_dijkstra(self):
        file_dijkstra = '/home/controlador/ryu/ryu/app/OSPF_bwd/Proac/paths_bwd.json'
    ...
    def calc_stretch(self):
        ...
        with open('/home/controlador/ryu/ryu/app/OSPF_bwd/Proac/stretch/'+str(self.count)+'_stretch.csv','wb') as csvfile:
