...
def get_dijkstra_paths():
    # weight = {1: {16: 1.5665292739868164, 3: 1.4333724975585938, 7: 1},
    ...
    weight = {1: {16: 1, 3: 1, 7: 1},
             2: {4: 1, 7: 1, 12: 1, 13: 1, 18: 1, 23: 1},
             3: {1: 1, 10: 1, 11: 1, 21: 1, 14: 1},
             4: {16: 1, 2: 1},
             5: {8: 1, 16: 1},
             6: {19: 1, 7: 1},
             7: {1: 1, 2: 1, 6: 1, 17: 1, 19: 1, 21: 1},
             8: {9: 1, 5: 1},
             9: {8: 1, 16: 1, 15: 1},
             10: {11: 1, 16: 1, 3: 1, 12: 1, 17: 1},
             11: {10: 1, 3: 1},
             12: {2: 1, 10: 1, 22: 1},
             13: {17: 1, 2: 1, 19: 1, 14: 1},
             14: {3: 1, 13: 1}, 15: {9: 1, 20: 1},
             16: {1: 1, 10: 1, 4: 1, 5: 1, 9: 1},
             17: {10: 1, 23: 1, 20: 1, 13: 1, 7: 1}, 18: {2: 1, 21: 1},
             19: {13: 1, 6: 1, 7: 1},
             20: {17: 1, 22: 1, 15: 1},
             21: {18: 1, 3: 1, 7: 1},
             22: {20: 1, 12: 1},
    ...
    for src in switches:
        for dst in switches:
            if src != dst:
                ...
                distances = {}
                predecessors = {}
                paths[src][dst] = dijkstra(weight, src, dst, visited, distances, predecessors)

    with open('paths_weight.json','w') as json_file:
        json.dump(paths, json_file, indent=2)
    end = time.time()-a
    print(end)
    print(dijkstra(weight,20,3))
get_dijkstra_paths()