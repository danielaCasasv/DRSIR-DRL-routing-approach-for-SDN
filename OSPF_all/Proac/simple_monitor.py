...
#---------------------STATISTICS MODULE FUNCTIONS ----------------------------
        ...
        for stat in sorted(body, key=attrgetter('port_no')): #get the value of port_no form body
            ...
            if port_no != ofproto_v1_3.OFPP_LOCAL: 
                if port_no != 1 and self.awareness.link_to_port :
                    ...
                    file = '/home/controlador/ryu/ryu/app/OSPF_all/Proac/bw_r.txt' #random link capacities
    ...
    def write_values(self):
        ...
        if self.delay.link_delay:
            ...
            file_metrics = '/home/controlador/ryu/ryu/app/OSPF_all/Proac/Metrics/'+str(self.count_monitor)+'_net_metrics.csv'
